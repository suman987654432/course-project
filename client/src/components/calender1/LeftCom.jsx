            ...
            <div className="mb-6 sm:mb-8">
                ...
                <div className="flex items-center p-2 sm:p-3 mb-2 sm:mb-3 rounded-lg bg-teal-100 hover:shadow-md transition-shadow cursor-pointer w-full min-w-0">
                    ...
                    <div className="flex flex-row justify-between items-center w-full">
                        <span className="text-sm font-medium inline-block">Lesson 01 : Introduction about XD</span>
                        <span className="text-sm text-gray-600 flex-shrink-0 inline-block">30 mins</span>
                    </div>
                </div>
                ...
                {quizzes.map((quiz, i) => {
                    ...
                    return (
                        <div key={i} className={`flex items-center p-2 sm:p-3 mb-2 sm:mb-3 rounded-lg ${bgColor} hover:shadow-md transition-shadow cursor-pointer w-full min-w-0`}>
                            ...
                            <div className="flex flex-row justify-between items-center w-full">
                                <span className="text-sm font-medium inline-block">{quiz.title}</span>
                                <span className="text-sm text-gray-600 flex-shrink-0 inline-block">{quiz.duration}</span>
                            </div>
                        </div>
                    );
                })}
